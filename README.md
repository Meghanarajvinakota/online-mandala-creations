...
![screenshot](documentation/features/admin/add-course.png)
...
![screenshot](documentation/features/admin/edit-course.png)
...
![screenshot](documentation/features/admin/message.png)
...
![screenshot](documentation/features/admin/delete.png)
...
![screenshot](documentation/features/admin/respond.png)
...
![screenshot](documentation/features/admin/newsletter.png)
...
- Digital Mandala Sheet Sales
    - Sale of digital Mandala sheets to accompany the course material. Could sell the mandala sheets
...
![screenshot](documentation/entity.png)
...
[GitHub Projects](https://github.com/users/Meghanarajvinakota/projects/10/views/1) served as an Agile tool for this project.
...
- ![screenshot](documentation/word-tracker.png)

### Sitemap

I've used [XML-Sitemaps](https://www.xml-sitemaps.com) to generate a sitemap.xml file.
This was generated using my deployed site URL: https://online-manadala-creations-6dbde778a153.herokuapp.com/
...
User-agent: *
Disallow:
Sitemap: https://online-manadala-creations-6dbde778a153.herokuapp.com/sitemap.xml
```
...
The live deployed application can be found deployed on [Heroku](https://manadala-creations-16cd779294ab.herokuapp.com).
...
- From **User Groups**, click **Create New Group**.
	- Suggested Name: `group-manadala-creations` (group + the project name)
...
- From the **JSON** tab, select the **Import Managed Policy** link.
	...
	- Click **Review Policy**.
	- Suggested Name: `policy-manadala-creations` (policy + the project name)
	- Provide a description:
		- "Access to S3 Bucket for manadala-creations static files."
	- Click **Create Policy**.
- From **User Groups**, click your "group-manadala-creations".
- Click **Attach Policy**.
- Search for the policy you've just created ("policy-manadala-creations") and select it, then **Attach Policy**.
- From **User Groups**, click **Add User**.
	- Suggested Name: `user-manadala-creations` (user + the project name)
- For "Select AWS Access Type", select **Programmatic Access**.
- Select the group to add your new user to: `group-manadala-creations`
...
- From there, click **Add Endpoint**.
	- `https://online-manadala-creations-6dbde778a153.herokuapp.com/checkout/wh/`
...
- Select **Other (Custom name)** for the device type.
	- Any custom name, such as "Django" or manadala-creations
...
1. Go to the [GitHub repository](https://github.com/Meghanarajvinakota/online-mandala-creations) 
2. Locate the Code button above the list of files and click it 
3. Select if you prefer to clone using HTTPS, SSH, or GitHub CLI and click the copy button to copy the URL to your clipboard
4. Open Git Bash or Terminal
5. Change the current working directory to the one where you want the cloned directory
6. In your IDE Terminal, type the following command to clone my repository:
	- `git clone https://github.com/Meghanarajvinakota/online-mandala-creations/branches`
...
1. Log in to GitHub and locate the [GitHub Repository](https://github.com/Meghanarajvinakota/online-mandala-creations)
...
All media files are used from Google and pexels
