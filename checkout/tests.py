...
class CheckoutViewTestCase(TestCase):
    ...
    def test_checkout_no_courses(self):
        """
        Tests that the checkout page is not accessed
        when there are no courses in the basket
        """
    ...
    def test_checkout_process(self):
        """
        Attempts to checkout and simulate purchase of the test course
        """
